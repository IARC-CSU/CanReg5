## Bundle for CanReg5 realease 43. 2018/11/14
...
# package list
packages_list <-c("flextable","Rcpp", "data.table", "ggplot2","shiny","shinydashboard", "shinyjs","gridExtra", "scales", "Cairo","officer", "zip", "bmp", "jpeg", "png", "Rcan")
