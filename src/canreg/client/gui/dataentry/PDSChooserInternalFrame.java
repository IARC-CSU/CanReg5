...
public class PDSChooserInternalFrame extends javax.swing.JInternalFrame implements ActionListener {
    ...
    private void initValues() {
        LinkedList<PopulationDataset> populationDatasetsLinkedList = new LinkedList<>();
        LinkedList<PopulationDataset> worldPopulationDatasetsLinkedList = new LinkedList<>();
        populationDatasetsMap.values().stream().forEach((pds) -> {
        ...
        populationDataSetsList.setModel(new javax.swing.AbstractListModel() {
            @Override
            public int getSize() {
                return populationDatasets.length;
            }

            @Override
            public Object getElementAt(int i) {
                return populationDatasets[i];
            }
        });
        populationDataSetsList.addListSelectionListener(this::listElementChanged);
    }
    ...
    public void loadFromFile() {
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                PopulationDataset tempPDS = canreg.common.database.Tools.loadPopulationDatasetFromJSON(fileName);
                PDSEditorInternalFrame populationDatasetEditorInternalFrame = new PDSEditorInternalFrame(dtp, worldPopulationDatasets, this);
                if (idList.contains(tempPDS.getPopulationDatasetID())) {
                    ...
                    switch (choice) {
                        ...
                        case JOptionPane.NO_OPTION:
                            ...
                            populationDatasetEditorInternalFrame.setLocked(false);
                            break;
