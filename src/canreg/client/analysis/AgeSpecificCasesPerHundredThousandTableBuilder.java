...
public class AgeSpecificCasesPerHundredThousandTableBuilder extends AbstractEditorialTableBuilder {
    ...
    private static final Logger LOGGER = Logger.getLogger(AgeSpecificCasesPerHundredThousandTableBuilder.class.getName());
        ...
        if (incidenceData != null) {
            for (Object[] line : incidenceData) {
                try {
                    ...
                    LOGGER.log(Level.WARNING," Number format issue", nfe);
                }
                // Read next line
