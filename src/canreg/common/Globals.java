...
public class Globals {
    ...
    static String CHARSET_ENGLISH = "windows-1252";
    static String CHARSET_FRENCH = "windows-1252";
    static String CHARSET_SPANISH = "windows-1252";
    static String CHARSET_ITALIAN = "windows-1252";
    static String CHARSET_TURKISH = "windows-1254";
    static String CHARSET_ROMANIAN = "windows-1250";
    static String CHARSET_PORTUGUESE = "windows-1252";
    static String CHARSET_CHINESE = "UTF-8";
    static String CHARSET_THAI = "windows-874";
    static String CHARSET_KOREAN = "UTF-8";
    static String CHARSET_ARABIC = "windows-1256";
