...
public class PAContext extends Object {
    ...
    public void collectArray() throws PainterException {
        ...
        for(i = n - 1; i >= 0; i--){
            ...
            if(objectValue instanceof PAToken && ((PAToken) objectValue).type == PAToken.START_ARRAY){
                found = true;
                break;
            }
        }
    ...
    protected HashMap constructSystemDict(){
       ...
       // mul
        ...
        systemDict.put("setlinewidth", new PACommand() {
            ...
            public void execute(PAContext context) throws PainterException {
                ...
                if(oldStroke instanceof BasicStroke){
                    ...
                    newStroke = new BasicStroke((float) data[0], BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);
                }
        ...
        systemDict.put("setlinecap", new PACommand() {
            public void execute(PAContext context) throws PainterException {
                ...
                if(oldStroke instanceof BasicStroke){
                    ...
                    newStroke = new BasicStroke(1.0f, (int)data[0], BasicStroke.JOIN_ROUND);
                }
                context.pencil.graphics.setStroke(newStroke);
            }
        });
        ...
        systemDict.put("setmiterlimit", new PACommand() {
            public void execute(PAContext context) throws PainterException {
                ...
                if(oldStroke instanceof BasicStroke){
                    ...
                    newStroke = new BasicStroke(1.0f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, (float)data[0]);
                }
                context.pencil.graphics.setStroke(newStroke);
            }
        });
        ...
        systemDict.put("setdash", new PACommand() {
            public void execute(PAContext context) throws PainterException {
                ...
                if(oldStroke instanceof BasicStroke){
                    ...
                    newStroke = new BasicStroke(1.0f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 1.0f, dashpattern, dashoffset);
                }
                context.pencil.graphics.setStroke(newStroke);
            }
        });
        ...
        systemDict.put("dumpstack", new PACommand() {
            @Override
            public void execute(PAContext context) throws PainterException {
                Enumeration enum2 = context.operands.elements();
       ...
       // ifelse
        ...
        systemDict.put("charpath", new PACommand() {
            public void execute(PAContext context) throws PainterException {
                ...
                context.pencil.charpath((String) data[0], ((Boolean) data[1]).booleanValue());
            }
        });
