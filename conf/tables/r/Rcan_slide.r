...
tryCatch({
  ...
  canreg_load_packages(c("data.table", "ggplot2", "gridExtra", "scales", "Cairo","grid","officer","flextable", "zip", "bmp", "jpeg", "png","shiny.i18n", "Rcan"))
  ...
  doc <- rcan_slide(doc, dt_all, ls_args)
