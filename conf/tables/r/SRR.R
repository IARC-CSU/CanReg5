...
# SRR	
	dataM$SRR <- CalcSRR(dataM$PERIOD1_ASR,dataM$PERIOD1_VAR,dataM$PERIOD2_ASR,dataM$PERIOD2_VAR)
	dataF$SRR <- CalcSRR(dataF$PERIOD1_ASR,dataF$PERIOD1_VAR,dataF$PERIOD2_ASR,dataF$PERIOD2_VAR)
